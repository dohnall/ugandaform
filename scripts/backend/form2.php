...
if(isset($_GET['export'])) {
    ...
    $query = "SELECT cb1.*, b.name AS branch, b.division, b.machines, (SELECT SUM(cb2.payin) - SUM(cb2.payout) FROM ".DBPREF."currency_balance cb2 WHERE cb2.currency = 'USD' AND ((cb2.date < cb1.date) OR (cb2.date = cb1.date AND cb2.id <= cb1.id))) AS balance
